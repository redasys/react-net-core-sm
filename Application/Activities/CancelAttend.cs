    ...
    public class CancelAttend
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                if (attendance != null && attendance.IsHost) throw new RestException(HttpStatusCode.BadRequest, new { Activity = "You are the host and must attend" });
